import EmailParams from "./franco.interface.js";


export class NotificacaoDeEmail implements EmailParams {
  nome: string;
  cursos: string[]
  ...
  emailExpiracao( nome: string, cursos: string[] ): string {
    return (
      `
            <!DOCTYPE html>
            <html lang="pt">
                  ...
                  <tr>
                    <td>
                      <p style="color: #565656; padding: 0px 32px;">
                        ...
                        <spans style="font-weight: 700;"> ${cursos}</spans> expirou.
  ...
  emailConfirmacao( nome: string, cursos: string[] ): string {
    return (
      `
  ...
  emailStatusFila( nome: string, cursos: string[] ): string {
    return (
      `
